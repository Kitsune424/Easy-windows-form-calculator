namespace WindowsForm_Calculator
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            Current_numstring.MinimumSize = new Size(357, 52);
            Current_numstring.Name = "Current_numstring";
            Current_numstring.ReadOnly = true;
            Current_numstring.ShortcutsEnabled = false;
            Current_numstring.Size = new Size(357, 52);
            ...
            // button_equals
            // 
            button_equals.BackColor = Color.FromArgb(216, 216, 216);
            button_equals.FlatAppearance.BorderColor = Color.FromArgb(216, 216, 216);
            ...
            button_equals.TabIndex = 12;
            button_equals.Text = "=";
            button_equals.UseVisualStyleBackColor = false;
            button_equals.Click += equals_operation;
            // 
            // button_division
            // 
